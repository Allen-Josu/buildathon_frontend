...
export default function HomeDashboard() {
    ...
    return (
        <div className="w-full min-h-screen px-4 md:px-6 lg:px-8 py-6 overflow-hidden  bg-[#27272a]">
            <div className="flex flex-col lg:flex-row gap-8 lg:gap-12 text-gray-300">
                {/* Left section */}
                ...
                <div className="w-full lg:w-1/2 flex justify-center items-center">
                    <div className="relative h-[300px] md:h-[400px] lg:h-[500px] w-full overflow-hidden flex justify-center items-center">
                        <img
                            src={project_pic}
